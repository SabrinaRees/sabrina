    ...
    const formSupportsPost = false;
        ...
        if (validate_form()) {
            ...
            async function submitForm() {
              ...
              const response = await fetch('https://sabrinarees47747.activehosted.com/proc.php?jsonp=true', {
                headers: {
              ...
              return response.json();
                ...
                if (formSupportsPost) {
                  ...
                  _load_script('https://sabrinarees47747.activehosted.com/proc.php?' + serialized + '&jsonp=true', null, true);
                }
        }
        return false;
    };
